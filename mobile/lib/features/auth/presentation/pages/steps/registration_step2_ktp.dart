...
/// Step 2 of registration: upload KTP photo, auto-extract NIK,
/// let the user complete nama / tempat lahir / tanggal lahir, then submit.
...
class _RegistrationStep2KtpState extends ConsumerState<RegistrationStep2Ktp> {
  ...
  void _populateFields(KtpData data) {
    setState(() {
      ...
      final place = (data.birthPlace ?? data.birthPlaceRegency?.name)?.trim();
      if (place != null && place.isNotEmpty) {
        _birthPlaceCtrl.text = place.toUpperCase();
      }
  ...
  Future<void> _handleRegister() async {
    ...
    final birthPlaceText = _birthPlaceCtrl.text.trim().toUpperCase();
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          // Tempat Lahir – typed as on KTP (forced uppercase)
          ProfessionalTextField(
