...
if [ -f "$APP_DIR/.env" ]; then
    ...
    cp "$APP_DIR/.env" /tmp/kms-connect-env-backup-$(date +%Y%m%d-%H%M%S)
...
if [ -f "$APP_DIR/docker-compose.prod.yml" ]; then
    ...
    sed -i 's|# - ./nginx/data.kms-connect.com.http-only.conf:/etc/nginx/conf.d/data.kms-connect.com.conf:ro|- ./nginx/data.kms-connect.com.http-only.conf:/etc/nginx/conf.d/data.kms-connect.com.conf:ro|g' "$APP_DIR/docker-compose.prod.yml"
    sed -i 's|- ./nginx/data.kms-connect.com.conf:/etc/nginx/conf.d/data.kms-connect.com.conf:ro|# - ./nginx/data.kms-connect.com.conf:/etc/nginx/conf.d/data.kms-connect.com.conf:ro|g' "$APP_DIR/docker-compose.prod.yml"
...
LATEST_BACKUP=$(ls -t /tmp/kms-connect-env-backup-* 2>/dev/null | head -1)
