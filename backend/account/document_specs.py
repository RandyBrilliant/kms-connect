...
Fase POST_INTERVIEW (diunggah setelah lulus interview; bukti penyerahan dari tahap INTERVIEW):
  0. Bukti Penyerahan Dokumen (opsional, PDF — tersedia saat tahap interview)
